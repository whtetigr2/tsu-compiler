...
The IR (`tsu_compiler.ir`) admits exactly two term kinds, `Linear` and `Product`, and
...
`load_rules` dispatching on `rule_class` in `tsu_compiler.rules`. Nothing here reads
