...
never a blank, a zero, or an invented value. ESS and Mixing (tsu_compiler.ess) print a
...
def render_report(receipt_dir) -> str:
    ...
    lines.append(_line("Colour blocks:",
                       _rep_display(metrics, rep_row, verdict, "colour_blocks",
                                    "colour_blocks")))
    # ESS/Mixing (tsu_compiler.ess) render the real measurement when the compile's own
    ...
    # tsu_compiler.ess's reliability threshold).
...
# ============================================================================
# C3: `tsuc explain` -- the fuller, teaching-trace rendering. `tsuc report`
