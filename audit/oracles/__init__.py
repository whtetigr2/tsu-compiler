...
package reading data produced by src/tsu_compiler (receipts, program.json, etc.) for
comparison -- is fine; what is forbidden is importing src/tsu_compiler's *code* into
